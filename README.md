...
StigForge-exported Ansible role **`ubuntu22_stig`** · release **`0.2.3-private-review`**.
...
```bash
ansible-galaxy role install stigready.ubuntu22_stig,0.2.3-private-review
```
...
|---|---:|---:|---|---|---|
| `stig` | **100.0%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260729T082911Z |
