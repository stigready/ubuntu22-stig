...
StigForge-exported Ansible role **`ubuntu22_stig`** · release **`0.2.4`**.
...
```bash
ansible-galaxy role install stigready.ubuntu22_stig,0.2.4
```
...
|---|---:|---:|---|---|---|
| `stig` | **100.0%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260729T223213Z |
